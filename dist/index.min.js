...
/* harmony default export */ __webpack_exports__["a"] = ((generator, that, ...args) => new Promise((resolve, reject) => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__style_main_sass__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_platform__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__loader__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__page__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__games__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__nav__ = __webpack_require__(24);
...
if(window.IS_MOBILE) {
  Array.prototype.forEach.call(document.querySelectorAll('.vh'), (vh) => {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_3__page_on_resize__["a" /* default */])(resize);
    resize();
  });
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_wait__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__prompt__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__border__ = __webpack_require__(19);
...
function end() {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_3__border__["a" /* default */])();
}

Object(__WEBPACK_IMPORTED_MODULE_0__util_generate__["a" /* default */])(function*() {
  yield Object(__WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */])(500);
  yield prompt.setCommand('cd public_html');
  yield Object(__WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */])(100);
  prompt = prompt.next();
  yield Object(__WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */])(500);
  ...
  for(let i = 0; i < 3; ++i) {
    yield Object(__WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */])(250);
    prompt.command += '.'
  }
  yield Object(__WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */])(250);
  end();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__page_svg__ = __webpack_require__(5);
...
while(paths.length < 4) {
  const path = __WEBPACK_IMPORTED_MODULE_0__page_svg__["b" /* createElement */]('path');
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](path, 'd', pathstr);
  const len = path.getTotalLength();
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](path, 'stroke-dasharray', `${len} 0`);
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](path, 'transform-origin', '0 0');
...
function transform() {
  ...
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](paths[0], 'transform', `translate(${x} ${y - h})`);
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](paths[1], 'transform', `translate(${x} ${y + h}) scale(1 -1)`);
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](paths[2], 'transform', `translate(${window.innerWidth - x} ${y - h}) scale(-1 1)`);
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](paths[3], 'transform', `translate(${window.innerWidth - x} ${y + h}) scale(-1 -1)`);
}
Object(__WEBPACK_IMPORTED_MODULE_1__page_on_resize__["a" /* default */])(transform);

function border() {
  transform();
  paths.forEach((path) => __WEBPACK_IMPORTED_MODULE_0__page_svg__["a" /* animate */](path, animationTime));
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__burst__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__logos__ = __webpack_require__(22);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__svg__ = __webpack_require__(5);
...
Object(__WEBPACK_IMPORTED_MODULE_1__on_resize__["a" /* default */])(() => {
  let h = 80;
  if(__WEBPACK_IMPORTED_MODULE_2__media__["a" /* phone */].matches) {
    h = 40;
  } else if(__WEBPACK_IMPORTED_MODULE_2__media__["b" /* tablet */].matches) {
