...
if(window.IS_MOBILE) {
  Array.prototype.forEach.call(document.querySelectorAll('.vh'), (vh) => {
    ...
    __WEBPACK_IMPORTED_MODULE_3__page_on_resize__["a" /* default */](resize);
    resize();
  });
}
...
function end() {
  ...
  __WEBPACK_IMPORTED_MODULE_3__border__["a" /* default */]();
}

__WEBPACK_IMPORTED_MODULE_0__util_generate__["a" /* default */](function*() {
  yield __WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */](500);
  yield prompt.setCommand('cd public_html');
  yield __WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */](100);
  prompt = prompt.next();
  yield __WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */](500);
  ...
  for(let i = 0; i < 3; ++i) {
    yield __WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */](250);
    prompt.command += '.'
  }
  yield __WEBPACK_IMPORTED_MODULE_1__util_wait__["a" /* default */](250);
  end();
...
while(paths.length < 4) {
  ...
  __WEBPACK_IMPORTED_MODULE_0__page_svg__["c" /* setAttribute */](path, 'transform-origin', '100% 100%');
...
__WEBPACK_IMPORTED_MODULE_1__page_on_resize__["a" /* default */](transform);
...
__WEBPACK_IMPORTED_MODULE_1__on_resize__["a" /* default */](() => {
  let h = 80;
  if(__WEBPACK_IMPORTED_MODULE_2__media__["a" /* phone */].matches) {
    h = 40;
  } else if(__WEBPACK_IMPORTED_MODULE_2__media__["b" /* tablet */].matches) {
