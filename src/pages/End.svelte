...
<div class='end {mobile ? 'mobile' : ''}'>
  <Paper>
    <div class='thanks'>
      <div class='title'>
        <Text heading>Thanks for visiting.</Text>
      </div>
      <div class='subtitle'>
        <Link href='mailto:cam.eldridge@gmail.com'><Text accent>get in touch</Text></Link>
      </div>
    </div>

    <div class='copyright'>
      <Text>&copy; 2019 &ndash; Cameron Eldridge</Text>
    </div>
  </Paper>
</div>
