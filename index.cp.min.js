...
/***/ function(module, exports, __webpack_require__) {
	...
	var _platform = __webpack_require__(322);

	var _platform2 = _interopRequireDefault(_platform);

	var _onResize = __webpack_require__(324);
	...
	if (window.IS_MOBILE) {
	  Array.prototype.forEach.call(document.querySelectorAll('.vh'), function (vh) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _generate = __webpack_require__(326);

	var _generate2 = _interopRequireDefault(_generate);

	var _wait = __webpack_require__(327);

	var _wait2 = _interopRequireDefault(_wait);

	var _prompt = __webpack_require__(328);

	var _prompt2 = _interopRequireDefault(_prompt);

	var _border = __webpack_require__(330);

	var _border2 = _interopRequireDefault(_border);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var prompt = new _prompt2.default(document.querySelector('.prompt'));
	  ...
	  return regeneratorRuntime.wrap(function _callee$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          _context.next = 2;
	          return (0, _wait2.default)(500);

	        case 2:
	          _context.next = 4;
	          return prompt.setCommand('cd public_html');
	        ...
	        case 9:
	          _context.next = 11;
	          return prompt.setCommand('npm start');
...
/***/ function(module, exports) {
	...
	*/
	...
	module.exports = function (generator, that) {
	  for (var _len = arguments.length, args = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
	    args[_key - 2] = arguments[_key];
	  }

	  return new Promise(function (resolve, reject) {
	    var run = generator.call.apply(generator, [that].concat(args));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _symbolic = __webpack_require__(329);
	...
	var _Symbolic = _slicedToArray(_symbolic2.default, 4);

	var ELEMENT = _Symbolic[0];
	var PROMPT = _Symbolic[1];
	var COMMAND = _Symbolic[2];
	var UPDATER = _Symbolic[3];
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	module.exports = (_module$exports = {}, _defineProperty(_module$exports, Symbol.iterator, regeneratorRuntime.mark(function _callee() {
	  return regeneratorRuntime.wrap(function _callee$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	  ...
	  return { value: Symbol(), done: false };
	}), _module$exports);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _svg = __webpack_require__(331);
	...
	var _media = __webpack_require__(332);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	var svg = document.querySelector('#header-border');
	var pathstr = 'M 102.342 18.469 C 103.487 9.722 87.048 1.975 76.015 4.733 C 62.536 8.103 55.473 17.155 50.833 29.915 C 34.031 76.121 98.523 184.441 7.337 184.441 L 7.337 185.586';
	...
	function transform() {
	  ...
	  var y = (window.IS_MOBILE ? window.orientation === 0 ? screen.height : screen.width : window.innerHeight) / 2;

	  var _paths$0$getBoundingC = paths[0].getBoundingClientRect();

	  var h = _paths$0$getBoundingC.height;
	...
	function border() {
	  ...
	  paths.forEach(function (path) {
	    return SVG.animate(path, animationTime);
	  });
	}
...
/***/ function(module, exports) {
	...
	function animate(path, time) {
	  ...
	  var segments = (getAttribute(path, 'd').match(/m/ig) || []).length;
	  var len = path.getTotalLength() / segments;
	  var finish = void 0,
	      cancel = void 0;
	  ...
	  var start = void 0;
	  var animation = window.requestAnimationFrame(function animate(now) {
	    if (start === undefined) {
	      start = now;
	    } else {
	      var newlen = len * Math.pow(Math.sin(Math.max(0, (time + start - now) / time) * Math.PI / 2), 2);
	  ...
	  finished.cancel = function () {
	    window.cancelAnimationFrame(animation);
	    cancel();
	  };
	  finished.skip = function () {
	    window.cancelAnimationFrame(animation);
...
/***/ function(module, exports) {
	...
	var phone = exports.phone = window.matchMedia('(max-width: 640px)');
	var tablet = exports.tablet = window.matchMedia('(min-width: 641px) and (max-width: 960px)');
	var desktop = exports.desktop = window.matchMedia('(min-width: 961px)');
...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.prototype.forEach.call(svgs, function (svg) {
	  ...
	  function transform() {
	    ...
	    var y = svg.getBoundingClientRect().height / 2 - paths[0].getBoundingClientRect().height / 2 * scale;
	  ...
	  (0, _generate2.default)(regeneratorRuntime.mark(function _callee() {
	    ...
	    return regeneratorRuntime.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            name = [].concat(_toConsumableArray(logo.classList)).filter(function (c) {
	              return c !== 'logo';
	            })[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sprites = __webpack_require__(338);

	var _sprites2 = _interopRequireDefault(_sprites);

	var _const = __webpack_require__(355);

	var _game = __webpack_require__(357);
	...
	var _wall = __webpack_require__(370);

	var _wall2 = _interopRequireDefault(_wall);

	var _spark = __webpack_require__(367);

	var _spark2 = _interopRequireDefault(_spark);

	var _bird = __webpack_require__(371);

	var _bird2 = _interopRequireDefault(_bird);

	var _butterfly = __webpack_require__(372);

	var _butterfly2 = _interopRequireDefault(_butterfly);

	var _door = __webpack_require__(373);

	var _door2 = _interopRequireDefault(_door);

	var _flower = __webpack_require__(374);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sprite = __webpack_require__(339);

	var _sprite2 = _interopRequireDefault(_sprite);

	var _bird = __webpack_require__(340);

	var _bird2 = _interopRequireDefault(_bird);

	var _bird_flying = __webpack_require__(341);

	var _bird_flying2 = _interopRequireDefault(_bird_flying);

	var _butterfly = __webpack_require__(342);

	var _butterfly2 = _interopRequireDefault(_butterfly);

	var _door = __webpack_require__(343);

	var _door2 = _interopRequireDefault(_door);

	var _flower_g = __webpack_require__(344);

	var _flower_g2 = _interopRequireDefault(_flower_g);

	var _flower_r = __webpack_require__(345);

	var _flower_r2 = _interopRequireDefault(_flower_r);

	var _flower_w = __webpack_require__(346);

	var _flower_w2 = _interopRequireDefault(_flower_w);

	var _grass = __webpack_require__(347);

	var _grass2 = _interopRequireDefault(_grass);

	var _player = __webpack_require__(348);

	var _player2 = _interopRequireDefault(_player);

	var _puff = __webpack_require__(349);

	var _puff2 = _interopRequireDefault(_puff);

	var _spark = __webpack_require__(350);

	var _spark2 = _interopRequireDefault(_spark);

	var _switch = __webpack_require__(351);

	var _switch2 = _interopRequireDefault(_switch);

	var _tree_g = __webpack_require__(352);

	var _tree_g2 = _interopRequireDefault(_tree_g);

	var _tree_r = __webpack_require__(353);

	var _tree_r2 = _interopRequireDefault(_tree_r);

	var _tree_w = __webpack_require__(354);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IMAGE = _Symbolic[0];
	var DIMENSIONS = _Symbolic[1];
	var LOADED = _Symbolic[2];
	var BLENDS = _Symbolic[3];
	var SPRITE = _Symbolic[4];
	...
	var Sprite = function () {
	  function Sprite(imageUrl) {
	    ...
	    var frames = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
	  ...
	  _createClass(Sprite, [{
	    ...
	    value: function draw(context, frame, x, y) {
	      var w = arguments.length <= 4 || arguments[4] === undefined ? this[DIMENSIONS][0] : arguments[4];
	      var h = arguments.length <= 5 || arguments[5] === undefined ? this[DIMENSIONS][1] : arguments[5];
	      var sx = arguments.length <= 6 || arguments[6] === undefined ? 1 : arguments[6];
	      var sy = arguments.length <= 7 || arguments[7] === undefined ? 1 : arguments[7];
	    ...
	    value: function drawRotated(context, frame, x, y, angle) {
	      var cx = arguments.length <= 5 || arguments[5] === undefined ? this[DIMENSIONS][0] / 2 : arguments[5];
	      var cy = arguments.length <= 6 || arguments[6] === undefined ? this[DIMENSIONS][1] / 2 : arguments[6];
	      var w = arguments.length <= 7 || arguments[7] === undefined ? this[DIMENSIONS][0] : arguments[7];
	      var h = arguments.length <= 8 || arguments[8] === undefined ? this[DIMENSIONS][1] : arguments[8];
	      var sx = arguments.length <= 9 || arguments[9] === undefined ? 1 : arguments[9];
	      var sy = arguments.length <= 10 || arguments[10] === undefined ? 1 : arguments[10];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _enumerate = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameEngine = __webpack_require__(358);

	var _gameEngine2 = _interopRequireDefault(_gameEngine);

	var _keyframes = __webpack_require__(361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _const = __webpack_require__(359);
	...
	var CANVAS = _Symbolic[0];
	var CONTEXT = _Symbolic[1];
	var ON = _Symbolic[2];
	var END = _Symbolic[3];
	var PAUSE = _Symbolic[4];
	var UNPAUSE = _Symbolic[5];
	var KEYFRAMES = _Symbolic[6];
	var ACTORS = _Symbolic[7];
	var BACKGROUNDS = _Symbolic[8];
	var FOREGROUNDS = _Symbolic[9];
	var PLAYING = _Symbolic[10];
	var GLOBAL = _Symbolic[11];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GAME = _Symbolic[0];
	var EXECUTE = _Symbolic[1];
	var METHOD = _Symbolic[2];
	var TARGET = _Symbolic[3];
	var FLAGS = _Symbolic[4];
	var DISTANCE = _Symbolic[5];
	var DIRECTION = _Symbolic[6];
	var RANDOM = _Symbolic[7];
	var COLLISION = _Symbolic[8];
	var NEAREST = _Symbolic[9];
	var AT = _Symbolic[10];
	var TO_POSITION = _Symbolic[11];
	function Util(game) {
	  var method = '';
	  var target = null;
	  var flags = new Set();
	      ...
	      for (var _iterator = targets[0][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        try {
	          for (var _iterator2 = targets[1][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            ...
	            var ori_a = a.origin;
	            var dim_a = a.dimensions;
	            var pos_b = b.position;
	            var ori_b = b.origin;
	            var dim_b = b.dimensions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var INDICES = _Symbolic[0];
	var FRAMES = _Symbolic[1];
	var PAIRS = _Symbolic[2];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actor = __webpack_require__(364);
	...
	var _solid = __webpack_require__(366);
	...
	var _puff = __webpack_require__(369);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPRITE = _Symbolic[0];
	var POSITION = _Symbolic[1];
	var GAME = _Symbolic[2];
	var ORIGIN = _Symbolic[3];
	var BLEND = _Symbolic[4];
	var SUBIMAGE = _Symbolic[5];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pad = __webpack_require__(368);
...
/***/ function(module, exports) {
	...
	*/
	...
	module.exports = function (str, char, len) {
	  var end = arguments.length <= 3 || arguments[3] === undefined ? false : arguments[3];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DIMENSIONS = _Symbolic[0];

	var Wall = function (_Solid) {
	  _inherits(Wall, _Solid);

	  function Wall(position, dimensions) {
	    var hasGrass = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];
	    ...
	    value: function update() {
	      ...
	      if (! --this.moveTimer) {
	        ...
	        if (this.game.util.distance.from(this).to(this.player) < 48) {
	          ...
	          var dy = this.y - this.player.position[1];
	          ...
	          var _dy = this.y - this.startPosition[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sprites = __webpack_require__(378);

	var _sprites2 = _interopRequireDefault(_sprites);

	var _backgrounds = __webpack_require__(386);

	var _backgrounds2 = _interopRequireDefault(_backgrounds);

	var _game = __webpack_require__(391);

	var _game2 = _interopRequireDefault(_game);

	var _grass = __webpack_require__(393);

	var _grass2 = _interopRequireDefault(_grass);

	var _dave = __webpack_require__(395);

	var _dave2 = _interopRequireDefault(_dave);

	var _waitor = __webpack_require__(396);

	var _waitor2 = _interopRequireDefault(_waitor);

	var _wheel = __webpack_require__(399);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dave = __webpack_require__(379);

	var _dave2 = _interopRequireDefault(_dave);

	var _waitor = __webpack_require__(380);

	var _waitor2 = _interopRequireDefault(_waitor);

	var _grass = __webpack_require__(381);

	var _grass2 = _interopRequireDefault(_grass);

	var _wheel = __webpack_require__(382);

	var _wheel2 = _interopRequireDefault(_wheel);

	var _coal = __webpack_require__(383);

	var _coal2 = _interopRequireDefault(_coal);

	var _monster = __webpack_require__(384);

	var _monster2 = _interopRequireDefault(_monster);

	var _fork = __webpack_require__(385);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _background = __webpack_require__(387);

	var _background2 = _interopRequireDefault(_background);

	var _foreground = __webpack_require__(388);

	var _foreground2 = _interopRequireDefault(_foreground);

	var _train = __webpack_require__(389);

	var _train2 = _interopRequireDefault(_train);

	var _rails = __webpack_require__(390);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Background = function () {
	  function Background(imageUrl) {
	    ...
	    var position = arguments.length <= 1 || arguments[1] === undefined ? [0, 0, -1000000] : arguments[1];
	  ...
	  _createClass(Background, [{
	    ...
	    key: 'copy',
	    value: function copy() {
	      var position = arguments.length <= 0 || arguments[0] === undefined ? this[POSITION] : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyframes = __webpack_require__(392);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actor = __webpack_require__(394);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _monster = __webpack_require__(397);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coal = __webpack_require__(398);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sprites = __webpack_require__(401);

	var _sprites2 = _interopRequireDefault(_sprites);

	var _backgrounds = __webpack_require__(405);
	...
	var _abby = __webpack_require__(413);

	var _abby2 = _interopRequireDefault(_abby);

	var _monster = __webpack_require__(415);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _abby = __webpack_require__(402);

	var _abby2 = _interopRequireDefault(_abby);

	var _elliot = __webpack_require__(403);

	var _elliot2 = _interopRequireDefault(_elliot);

	var _monster = __webpack_require__(404);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bush = __webpack_require__(406);

	var _bush2 = _interopRequireDefault(_bush);

	var _tree_ = __webpack_require__(407);

	var _tree_2 = _interopRequireDefault(_tree_);

	var _tree_3 = __webpack_require__(408);

	var _tree_4 = _interopRequireDefault(_tree_3);

	var _grass = __webpack_require__(409);

	var _grass2 = _interopRequireDefault(_grass);

	var _flowers = __webpack_require__(410);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyframes = __webpack_require__(412);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actor = __webpack_require__(414);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sprites = __webpack_require__(417);

	var _sprites2 = _interopRequireDefault(_sprites);

	var _backgrounds = __webpack_require__(423);

	var _backgrounds2 = _interopRequireDefault(_backgrounds);

	var _game = __webpack_require__(425);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _board = __webpack_require__(424);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyframes = __webpack_require__(426);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actor = __webpack_require__(428);
	  ...
	  _createClass(Player, [{
	    ...
	    value: function update() {
	      ...
	      if (this.destination !== null) {
	        ...
	        var dy = this.destination[1] - this.previous[1];
	  ...
	  _createClass(Card, [{
	    ...
	    value: function update() {
	      if (this.travelTimer !== null) {
	        ...
	        var dy = destination[1] - previous[1];
